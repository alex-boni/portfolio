function SocialNetworks() {
  return (
    <div className="flex flex-row gap-4 justify-center items-center">
      <a
        className="z-10"
        href="https://github.com/alex-boni"
        target="_blank"
      ...
      >
        <svg
          ...
          viewBox="0 0 24 24"
        >
          {/* Forzamos fill para que siempre se vea */}
          <path
      ...
      <a
        className="z-10"
        href="https://linkedin.com/in/alex-boni/"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="LinkedIn"
      >
      ...
      >
        <img
          src="https://play-lh.googleusercontent.com/KSuaRLiI_FlDP8cM4MzJ23ml3og5Hxb9AapaGTMZ2GgR103mvJ3AAnoOFz1yheeQBBI=w240-h480-rw"
          srcset="https://play-lh.googleusercontent.com/KSuaRLiI_FlDP8cM4MzJ23ml3og5Hxb9AapaGTMZ2GgR103mvJ3AAnoOFz1yheeQBBI=w480-h960-rw 2x"
          className="w-10 rounded-2xl"
          aria-hidden="true"
          alt="Imagen de gmail"
          itemprop="image"
          data-iml="338.39999997615814"
          data-atf="true"
        ></img>
      </a>
    </div>
